...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\025\000\006\003\006\004\004\001\002\000\006\011" +
    "\014\012\015\001\002\000\010\002\000\003\006\004\004" +
    "\001\002\000\004\013\012\001\002\000\010\002\ufffe\003" +
    ...
    "\014\005\ufff6\006\ufff6\007\ufff6\010\ufff6\013\ufff6\001\002" +
    "\000\014\005\020\006\017\007\022\010\021\013\023\001" +
    "\002\000\006\011\014\012\015\001\002\000\006\011\014" +
    "\012\015\001\002\000\006\011\014\012\015\001\002\000" +
    "\006\011\014\012\015\001\002\000\010\002\ufffd\003\ufffd" +
    "\004\ufffd\001\002\000\014\005\ufff9\006\ufff9\007\ufff9\010" +
    "\ufff9\013\ufff9\001\002\000\014\005\ufff8\006\ufff8\007\ufff8" +
    "\010\ufff8\013\ufff8\001\002\000\014\005\ufffb\006\ufffb\007" +
    "\022\010\021\013\ufffb\001\002\000\014\005\ufffa\006\ufffa" +
    "\007\022\010\021\013\ufffa\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\025\000\010\002\007\003\006\004\004\001\001\000" +
    "\004\005\015\001\001\000\004\003\012\001\001\000\002" +
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		ArrayList<NodoAST> lista = (ArrayList<NodoAST>)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
...
Datos.raiz = raiz;
		...
		ArrayList<NodoAST> lista = (ArrayList<NodoAST>)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		...
		NodoAST inst = (NodoAST)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
...
RESULT = nodo;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // instruccion ::= EVALUAR expresion PTCOMA 
            {
              NodoAST RESULT =null;
		int expleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int expright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		NodoAST exp = (NodoAST)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
...
RESULT = inst;
		...
		NodoAST exp1 = (NodoAST)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		int opleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int opright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		String op = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		int exp2left = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int exp2right = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		NodoAST exp2 = (NodoAST)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
...
RESULT = operacion;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // expresion ::= expresion RESTA expresion 
            {
              NodoAST RESULT =null;
		int exp1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int exp1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
...
RESULT = operacion;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // expresion ::= NUMERO 
            {
              NodoAST RESULT =null;
		int numleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int numright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		String num = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new NodoAST(TipoNodo.ENTERO, num); 
		...
		int numright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		String num = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new NodoAST(TipoNodo.DECIMAL, num); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expresion",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
